      ...
      <div class="modal-dialog modal-xl" role="document">
         <div class="modal-content border-0">
            ...
            <div class="modal-footer">
               ...
               </button> <!-- 使用emit註冊方法並帶入tempProducts -->
               <button type="button" class="btn btn-primary" @click="$emit('update-Products',tempProducts)">確認</button>
            </div>
         </div>
      </div>
...
<script>
   ...
   export default {
      ...
      watch: {
         products() { // 監聽 props屬性中的 products 當每次改變時傳入 tempProducts 儲存
      ...
      methods: {
         ...
         uploadFile() {
            ...
            this.$http.post(url, formData).then((res) => { // 將連線後將 formData 送入後端

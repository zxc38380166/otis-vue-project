    ...
    >
      <div class="toast-header">
        <strong class="me-auto" v-if="Msg.success == true">
          <i class="bi bi-square-fill" style="color: rgb(34, 156, 44)"></i
          >執行成功
        </strong>
        <strong class="me-auto" v-else-if="Msg.success == false">
          <i class="bi bi-square-fill" style="color: rgb(235, 34, 34)"></i
          >執行失敗
        </strong>
      ...
      <div class="toast-body fs-5" style="background-color: rgb(224, 224, 224)">
        {{ Msg.message }}
      </div>
    </div>
  </div>

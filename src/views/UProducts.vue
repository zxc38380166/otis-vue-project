<template>
  <div class="d-flex flex-wrap justify-content-center bg-dark">
    ...
    <div class="w-100 row py-2">
      ...
      <div class="d-flex col-12 col-sm-6 justify-content-center">
        <input class="form-control w-25" type="search" placeholder="搜尋" aria-label="Search" />
        <button class="btn btn-outline-success" type="submit" @click="CartModal">
                  ...
                  <div class="col-12 col-sm-6 py-1">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <p class="text-muted">
                          <i class="bi bi-shop" style="font-size: 1.5rem; color: cornflowerblue"></i>
                          嘉義縣中埔鄉富收村富和路51號
                        </p>
                        <p class="text-muted">
                          <i
